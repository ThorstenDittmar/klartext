...
- [x] **Step 3: Commit** (combined with Tasks 2-4)
...
- [x] **Step 3: Commit** (combined with Tasks 1, 3-4)
...
- [x] **Step 2: Commit** (combined with Tasks 1-2, 4)
...
- [x] **Step 2: Verify the skill is accessible**
...
- [x] **Step 3: Commit** (combined with Tasks 1-3)
