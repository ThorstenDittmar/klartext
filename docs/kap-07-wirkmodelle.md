...
Ein narratives Artefakt ist ein erzählerisches Werk oder Teilwerk, das auf ein Wirkmodell bezogen ist. Narrative Einheiten sind seine strukturierten Bestandteile, etwa Werk, Teil, Kapitel, Szene, Fragment, Figur, Handlung oder narrativer Konflikt. Sie werden nicht selbst zu kausalen Modellen, können aber auf Modellelemente verweisen und durch diese geprüft werden.
