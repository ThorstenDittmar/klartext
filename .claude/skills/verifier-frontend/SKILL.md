...
description: Verify that frontend changes work correctly by running the app and observing behavior in the browser. Use when verifying UI changes, component extractions, or token compliance passes.
---
